...
public class TC_27 
{
	...
	{
		List<WebElement> recentlycreated= driver.findElements(By.xpath("//select[@id='hotlist_mode']/option"));
		for(WebElement element : recentlycreated)
		{
			if(element.getText().equals("Recently Created"))
			{
				System.out.println("Validation :"+element.getText());
				element.click();
				break;
			}
		}
