...
public class TC_29 
{
	...
	{
		driver.findElement(By.xpath("//a[contains(text(),'Aaahi, Aaahi')]")).click();// to click on first contact
		
		System.out.println("Contact Information Title :"+driver.getTitle());// to validate the contact page
	}
