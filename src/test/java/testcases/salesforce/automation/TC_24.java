...
public class TC_24 
{
	...
	public static void clickOnNew()
	{
		...
		String newLeadPage=driver.getTitle();
		System.out.println("Valid Page Populated :"+newLeadPage);
		
	}
	public static void accountCreation()
	{
		WebElement enterLastName=driver.findElement(By.xpath("//input[@id='name_lastlea2']"));
		enterLastName.sendKeys("ABCD");
		
		WebElement enterCompany=driver.findElement(By.xpath("//input[@id='lea3']"));
		enterCompany.sendKeys("ABCD");
		
		WebElement clickSave=driver.findElement(By.xpath("//td[@id='bottomButtonRow']//input[@title='Save']"));
		clickSave.click();
		
		String title=driver.getTitle();
		System.out.println("New Lead Creation :"+title);
	}
